...
const PastEventCard = ({pasteventdata}) => {
  return (
    <>
      <div className='flex hover:shadow-2xl hover:shadow-blue-600 transition ease-in-out hover:-translate-y-6 flex-col border-2 border-gfgmaincolor shadow-lg md:w-1/4 w-full h-min rounded-3xl'>
